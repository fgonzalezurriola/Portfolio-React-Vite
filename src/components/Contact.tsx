    ...
    <section id="contact" className="py-10 bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center space-x-8">
          {/* Gmail */}
          <a href={`mailto:${email}`} target="_blank" rel="noreferrer noopener"  className="text-gray-700 dark:text-gray-300 hover:text-blue-500 transition duration-300 flex flex-col items-center">
